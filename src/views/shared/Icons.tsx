...
import type { ContactKind } from "@models/types";
...
/** Mapeia o tipo de contato ao seu ícone. */
export const contactIcon: Record<ContactKind, Icon> = {
  phone: PhoneIcon,
  email: EmailIcon,
